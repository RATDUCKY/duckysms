...
banner()
sdt=input(str('\033[1;33mTelefon Numarasını Gir: '))
time_delay = int(input('\033[1;33mZaman Aralığı(saniye): '))
print('\033[1;97m===========================================================================')
stt=0
while True:
    stt+=1
    ...
    print(f'\033[1;97m[{stt}]\033[1;96m Mesaj İletildi\033[1;94m-\033[1;95mPhone\033[1;94m-\033[1;94m{sdt}')
